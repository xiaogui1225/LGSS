...
namespace SSGL
{
    public partial class Frm002_登录 : Form
    {
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            
        }
        public Frm002_登录(object text)
        {
            InitializeComponent();
        ...
        public Frm001_主界面 Frm001_主界面;
        public Frm002_登录()
        {
            InitializeComponent();
            txtPwsd.UseSystemPasswordChar = true;//大圆点
        }
        private void Frm002_Frm002Closed(object sender, FormClosedEventArgs e)
        {
            //Frm001_主界面 f1 = new Frm001_主界面();
            //f1 = (Frm001_主界面)this.Owner;
            //this.Owner.Hide();
            //f1.Dispose();
            //f1.Hide();
        }
        Frm001_主界面 frm001;
        public Frm002_登录(Frm001_主界面 form1)
        {
            InitializeComponent();
            frm001 = form1;//得到传过来的frm001
        }
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            ...
            //访问数据库
            //string strSql = "server=.;user=sa;pwd=1;database=SSGL;"; /*使用云ip 连接数据库*/
            //string strSql = "server=103.46.128.43,40243;database=SSGL;uid=sa;pwd=QQqq1343000";
            ...
            if (radStudent.Checked == true)
            {
                try
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        {
                            //Frm001_主界面 f1 = new Frm001_主界面(f001);
                            //f1.Owner = this;
                            //f1.Close();
                            result = true;
                            MessageBox.Show("登录成功");
                            frm001.Hide();
                            Frm001_主界面 myFrm01 = new Frm001_主界面(txtNo.Text);
                            //this.FindForm();
                            myFrm01.Owner = this;
                ...
                try
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        if (txtPwsd.Text.Trim()==dr["aPwsd"].ToString().Trim())
                        {
                            ...
                            myFrm01.Tool切换用户.Enabled = true;
                            myFrm01.Tool注销.Enabled = true;
                            myFrm01.Toolsmt2.Visible = false;
