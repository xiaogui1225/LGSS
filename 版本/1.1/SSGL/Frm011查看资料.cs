...
namespace SSGL
{
    public partial class Frm011查看资料 : Form
    {
        public Frm011查看资料()
        {
            InitializeComponent();
        ...
        private void but2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(sql.sqlstr);
        ...
        private void but3_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlStr sql = new sqlStr();//跟下面的一条语句效果一样
                //string sqlStr = "server=.;user=sa;pwd=1;database=ssgl";
...
class sqlStr
{
    public static string SqlStr = "server=.;user=sa;pwd=1;database=ssgl;";
